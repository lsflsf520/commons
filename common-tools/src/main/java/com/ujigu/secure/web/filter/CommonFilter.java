...
public class CommonFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		ThreadUtil.put(ThreadUtil.CURR_URL, currUrl);
		...
		String srcProjectName = httpRequest.getHeader(ThreadUtil.SRC_PROJECT_NAME);
		ThreadUtil.setSrcProject(srcProjectName);
		ThreadUtil.setSrcIP(WebUtils.getClientIp(httpRequest));
		ThreadUtil.put(ThreadUtil.RESPONSE_NAME, (HttpServletResponse)response);
		ThreadUtil.put(ThreadUtil.REQUEST_NAME, httpRequest);
		ThreadUtil.put(ThreadUtil.SERVLET_URI_NAME, servletUri);
		ThreadUtil.put(ThreadUtil.IS_WX_CLIENT_NAME, WebUtils.isWxClient(httpRequest));
		...
		try {
			...
			+ ",loginName:" + ThreadUtil.get(ThreadUtil.LOGIN_NAME)
			...
			LogUtils.logXN(WebUtils.getCurrParamUrl(httpRequest) + " " + code + " " + (WebUtils.isAjax(httpRequest) ? "ajax " : "http ")
		                   ...
		                   + (ThreadUtil.getUserId() == null ? "" : "uid(" + ThreadUtil.getUserId() + ")" )
