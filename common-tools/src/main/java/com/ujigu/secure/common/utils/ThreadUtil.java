...
public class ThreadUtil {
	...
	public final static String LOGIN_NAME = "ln";
	public final static String REAL_NAME = "rn";
	public final static String USER_ICON = "uic";
	public final static String ROLE_NAME = "rnm";
	public final static String ACID_NAME = "acid";
	public final static String ADID_NAME = "adid";
	private final static String USER_INFO = "uinfo"; //用户存储当前登录对象
	
	public final static String NICE_NAME = "nin"; //投保人/代理人web端使用
	public final static String USER_TYPE = "ut"; //投保人/代理人web端使用
	public final static String POSTER_CODE = "pc"; //投保人/代理人web端使用
	public final static String MY_CODE = "mc"; //投保人/代理人web端使用
	public final static String USER_GRADE = "ug"; //投保人/代理人web端使用 当前用户等级
	
	public final static String CURR_DOMIAN_NAME = "cdn";
	public final static String CURR_PORT_NAME = "currpn";
	
	public final static String OPENID_NAME = "oinm"; //openID
	public final static String CHANNEL_NAME = "chnm"; //第三方渠道标识
	public final static String SUBSCRIBE_NAME = "subnm"; //是否关注了公众号
	
	public final static String REMINDME = "rmd"; //记住一周的标识
	
	public final static String QQ = "qq";
	public final static String EMAIL = "eml";
	public final static String PHONE = "phe";

	public final static String LOGIN_IP = "lip";
	public final static String EQUIP_TYPE = "et"; // 设备类型，比如pc、android、iPhone、ipod、ipad等

	public final static String TOKEN = BaseConfig.getValue("sys.session.token.key", "tk"); // 需要被存入到cookie中的token的key
	public final static String LOGIN_TIME = "lt";
	
	public final static String RESPONSE_NAME = "respnm";
	public final static String REQUEST_NAME = "reqnm";
	public final static String SERVLET_URI_NAME = "sun";
	public final static String CURR_URL = "cul";
	public final static String IS_WX_CLIENT_NAME = "wxcn";
	public final static String SITE_NAME = "site";
	public final static String IS_MOBILE_CLIENT = "mobcln"; //是否为移动端
	
	public final static String COOKIE_PT_CODE_NAME = "ptecd";

	public final static String TRACE_MSG_ID = "tmi";
	public final static String SRC_PROJECT_NAME = "spn";
	
	private final static String SESSION_ID_NAME = "sid";
	...
	private final static String FROM_TYPE = "ftype";//存储来源pc,h5,app
	
	private final static String FROM_URL = "fu";
	
	private final static String IS_SHARE = "ish";
	...
	public static void setFromUrl(String fromUrl){
		put(FROM_URL, fromUrl);
	}
	...
	public static boolean getIsShare(){
		return (boolean) (get(IS_SHARE) == null ? false : get(IS_SHARE));
	}
	...
	public static void setCurrDomain(String currDomain){
		putIfAbsent(CURR_DOMIAN_NAME, currDomain);
	}
	
	public static void setCurrPort(int port){
		putIfAbsent(CURR_PORT_NAME, port);
	}
	...
	public static String getDomainPrefix(){
		...
		return StringUtil.getDomainPrefix(domain);
	}
...
//		if(GlobalConstant.IS_WEB_PC || GlobalConstant.IS_WEB_H5){
			...
			return domain == null || (!domain.startsWith("m.") && !domain.equals(h5domain));
//		}
...
//		throw new BaseRuntimeException("NOT_SUPPORT", "本方法只支持在pc或者h5的web中使用");
	...
	public static void setSid(String sid){
		putIfAbsent(SESSION_ID_NAME, sid);
	}
	
	public static String getSid(){
		return (String)get(SESSION_ID_NAME);
	}
	...
	public static boolean isWxClient(){
		Object wxclient = get(IS_WX_CLIENT_NAME);
...
//			}
	...
	public static void printContent(){
		LogUtils.debug("ThreadLocal Param:%s", threadInfoMap.get());
	}
