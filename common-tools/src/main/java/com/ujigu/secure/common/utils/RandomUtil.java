...
public class RandomUtil {
    ...
    private static final String[] UPPER_ALPHA_NUM_ARR = {"A", "B","2", "C", "D","3", "E","F", "G",
        "7","H", "I", "5","J", "K", "L", "M", "4", "N", "P", "Q","9", "R","S", "T",
        "U", "8", "V","W", "X","6", "Y","Z" };
    
	private static final String[] ALPHA_NUM_ARR = {"A", "a", "B","b","2", "C", "c","D","d","3", "E","e", "F","f", "G","g",
        "7","H", "h","I", "i","5","J","j", "K", "k","L", "M", "m","4", "N", "n","P", "p","Q","q","9", "R","r", "S","s", "T","t",
        "U", "u","8", "V","v", "W", "w","X","x","6", "Y","y", "Z","z" };
...
//		return Math.abs(random.nextInt()) % range;
		return new Random(System.currentTimeMillis()).nextInt(range);
	}
	 ...
	 */
	public static String randomUpperNumCode(int codeLength) {
		return randomCode(UPPER_ALPHA_NUM_ARR, codeLength);
	}
	
	/**
	 * 生成指定长度的随机字符串(纯大写字母组成)
	 * @param codeLength
	 * @return
	 */
	public static String randomUpperCode(int codeLength) {
		return randomCode(UPPER_ALPHA_ARR, codeLength);
	}
     ...
     * @return 随机字符串
     */
	public static String randomAlphaNumCode(int length){
		StringBuilder sb = new StringBuilder();
