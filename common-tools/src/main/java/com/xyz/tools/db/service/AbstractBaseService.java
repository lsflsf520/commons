package com.xyz.tools.db.service;
...
//		return CollectionUtils.isEmpty(tlist) ? null : tlist.get(0);
	 ...
	 * @return
	 */
	protected List<T> findAll(String property, Direction direction) {
	 ...
	 * @return 
	 */
	protected List<T> findAll(String orderstr) {
	 ...
	 * @return
	 */
	protected List<T> findByEntity(T t){
	 ...
	 * @return
	 */
	protected List<T> findByEntity(T t, String property, Direction direction){
	 ...
	 * @return 
	 */
	protected List<T> findByEntity(T t, String orderstr){
	 ...
	 * @return
	 */
	protected List<T> findTopItems(T t, int topNum){
	 ...
	 * @return
	 */
	protected PageData<T> findByPage(T t, int currPage, int maxRow){
	 ...
	 * @return
	 */
	protected PageData<T> findByPage(T t, int currPage, int maxRow, String orderstr){
...
//			pageBounds.setLimit(Integer.MAX_VALUE - 100);
	...
	protected T findOne(T t, String property, Direction direction) {
		PageBounds pageBounds = new PageBounds(new Order(property, direction, null));
