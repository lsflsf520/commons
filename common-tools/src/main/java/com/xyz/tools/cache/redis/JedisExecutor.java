...
//	}
	...
	public RedisReturn<Long> rpush(JedisKeyNS key, Serializable id,
		...
		return extExec(key, id, new ExtOper<Long>(ExtOperType.CHANGE) {
			...
			Long exec(Jedis jedis, String keystr, Object middleKey,
					String... members) {
				return jedis.rpush(keystr, members);
			}
		}, null, members);
	}
	
	public RedisReturn<String> lpop(JedisKeyNS key, Serializable id) throws JedisConnectionException,
	JedisClientException{
		return extExec(key, id, new ExtOper<String>(ExtOperType.QUERY) {
			@Override
			String exec(Jedis jedis, String keystr, Object score,
					String... values) {
	...
	public RedisReturn<String> spop(JedisKeyNS key, Serializable id) throws JedisConnectionException,
	JedisClientException{
		return extExec(key, id, new ExtOper<String>(ExtOperType.QUERY) {
			@Override
			String exec(Jedis jedis, String keystr, Object score,
					String... values) {
				return jedis.spop(keystr);
			}
		}, null);
	}
