package com.yisi.stiku.common.exception;

import org.apache.commons.lang.StringUtils;

import com.yisi.stiku.common.bean.ResultCodeIntf;
import com.yisi.stiku.common.bean.ServiceResultCode;
...
public class BaseRuntimeException extends RuntimeException {
	...
	public BaseRuntimeException(String code, String message, String errorMsg, Throwable th) {

		this(new ServiceResultCode(code, message, errorMsg), th);
	}

	public BaseRuntimeException(String code, String message, String errorMsg, Object userData, Throwable th) {

		this(new ServiceResultCode(code, message, errorMsg), userData, th);
	}
