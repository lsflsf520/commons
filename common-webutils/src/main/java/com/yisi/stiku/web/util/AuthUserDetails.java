...
public class AuthUserDetails implements UserDetails {
     ...
     *             .
     */
    public AuthUserDetails(String username, String password, boolean enabled, Set<GrantedAuthority> authorities,String usernameDisplay)
            throws IllegalArgumentException {
...
//        this.accountNonLocked = accountNonLocked;
    ...
    public AuthUserDetails(String username, String password, boolean enabled, boolean accountNonExpired,
            ...
            Map<String, Object> attributes,String usernameDisplay) throws IllegalArgumentException {
        this(username, password, enabled, authorities,usernameDisplay);
